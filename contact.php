...
<title>تماس با هتل پارسیان بوعلی</title>
...
<div id="root-container" class="container">
  <div id="wrapper" class="sixteen columns"> 
    ...
    <div id="sub-banner">
      ...
      <img src="images/banner/sub-banner3.jpg" alt="" /> </div>
    ...
    <div id="menu" class="page">
      <ul id="root-menu" class="sf-menu">
        ...
        <li> <a href="contact.php" class="active">تماس با ما</a> </li>
      </ul>
    </div>
    <!-- Content -->
    <div id="content">
      <div id="intro">
        <h1><span>تماس با هتل پارسیان بوعلی</span></h1>
        <img src="images/map.jpg" alt="نقشه هتل بوعلی">
        <br><br>
        <strong>آدرس:</strong> همدان خیابان بوعلی کد پستی 65156
        <br>
        <strong>تلفن:</strong> 8252822-3 و 8250788
        <br>
        <strong>فاکس:</strong> 8276373
        <br>
        <br>
        <p>
